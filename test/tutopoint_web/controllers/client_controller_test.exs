defmodule TutopointWeb.ClientControllerTest do
  use TutopointWeb.ConnCase

  alias Tutopoint.Users

  @create_attrs %{name: "some name", phone: "some phone", stripe: "some stripe"}
  ...
  def fixture(:client) do
    {:ok, client} = Users.create_client(@create_attrs)
    client
  end
